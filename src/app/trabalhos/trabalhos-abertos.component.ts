...
@Component({
  selector: 'app-trabalhos-abertos',
  template: `
  <div class="row" style="background-color: #343a40; box-shadow: 0px 0px 3px rgb(73, 73, 73);">
    ...
    <div class="col s12">
        <div class="card-panel">
            ...
            <span class="card-title" style="font-size: 18pt; font-weight: bold; padding-left: 10%">Trabalhos Abertos</span>
            <div class="row">
...
export class TrabalhosAbertosComponent implements OnInit {
  ...
  ngOnInit() {
    this.trabalhoService.getTrabalhosAberto().subscribe(trabalhos => {
