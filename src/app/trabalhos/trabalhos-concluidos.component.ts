import { TrabalhosAtrasadosComponent } from './trabalhos-atrasados.component';
...
@Component({
  selector: 'app-trabalhos-concluidos',
  template: `
  <div class="row" style="background-color: #343a40; box-shadow: 0px 0px 3px rgb(73, 73, 73);">
    ...
    <div class="col s12">
        <div class="card-panel">
            ...
            <span class="card-title" style="font-size: 18pt; font-weight: bold; padding-left: 10%">Trabalhos Concluídos</span>
            <div class="row">
...
export class TrabalhosConcluidosComponent implements OnInit {
  ...
  ngOnInit() {
    this.trabalhoService.getTrabalhosConcluido().subscribe(trabalhos => {
